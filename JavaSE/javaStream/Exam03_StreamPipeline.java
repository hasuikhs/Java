 ...
 * 
 * 간단한 예제를 통해서 이해해보자
 * 직원 객체를 생성해서 ArrayList 안에 여러명의 직원을 저장
...
class Exam03_Employee implements Comparable<Exam03_Employee>{
	...
	public Exam03_Employee(String name, int age, String dept, String gender, int salery) {
		super();
		this.name = name;
		this.age = age;
		this.dept = dept;
...
//		System.out.println("IT부서의 남자평균 연봉 : " + avg);
		...
		employees.stream()
				 ...
				 .distinct()
				 .sorted(Comparator.reverseOrder())		// 오름차순이 기본, 인자가있으면 내림차순
